  ...
  auth = {
    signInWithPassword: async ({ email, password }: any) => {
      ...
      if (email.includes('admin')) {
        role = 'Admin'; id = 'admin-123'; staffId = 'ADM-001'; name = 'System Admin';
      } else if (email.includes('doctor')) {
        role = 'Doctor'; id = 'doc-123'; staffId = 'DOC-102'; name = 'Dr. Smith';
      } else if (email.includes('nurse')) {
        role = 'Nurse'; id = 'nur-123'; staffId = 'NUR-205'; name = 'Nurse John';
      }
